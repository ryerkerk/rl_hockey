...
if __name__ == "__main__":
    ...
    if WORLD == 'Hockey1v1':
        ...
        TRAIN_STEPS_PER_TRIAL = int(TRAIN_STEPS_PER_TRIAL/2)  # Use half training steps, will train same model twice

    elif WORLD == 'Hockey2v2Roles':
        # This world uses a separate controller for both agents
    ...
    for i in range(1, NUM_ITERATIONS):
        ...
        print('Iteration {}, memLen {}, loss {:.6f}, time {:.2f}, score {}, avg_score {:.2f}'.format(i, len(memory[0]),
              loss_mean, stop-start, world.get_scores()[:world.get_num_cpu()], score_mean))
